...
// mcp-timescale binaries, one per platform, each next to its cosign Sigstore
// bundle.
...
func newSelfUpdateCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "self-update",
		Short: "Update mcp-timescale to the latest version",
		Long: `Checks for the latest release of mcp-timescale on GitHub and
...
func runSelfUpdate(cmd *cobra.Command, _ []string) error {
	...
	// Self-update is disabled for development versions (e.g., "dev") as they
	// are not standard releases and do not follow semantic versioning.
